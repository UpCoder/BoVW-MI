...
if __name__ == '__main__':
    ...
    import os
    mat_path = '/home/give/PycharmProjects/BoVWMI/Code/data/xubo/histogram.mat'
    label_path = '/home/give/PycharmProjects/BoVWMI/Code/data/xubo/class.mat'
    ...
    for MI_SELECT_NUM in MI_SELECT_NUMS:
        ...
        save_mat_path = '/home/give/PycharmProjects/BoVWMI/Code/data/xubo/'
        save_mat_path = os.path.join(save_mat_path, 'histogram_' + str(MI_SELECT_NUM) + '.mat')
        scio.savemat(
            save_mat_path,
            {
                'histogram': images_hist_select
            }
        )
        print 'saving ', save_mat_path, ' finished'
        print 'image select shape is ', np.shape(images_hist_select)
        accuracy, param_record = SVM.do_svm(np.array(images_hist_select), np.array(labels), 3, False)
